...
export class Backend implements backendInterface {
    ...
    async getAllProducts(): Promise<Array<SeedProduct>> {
        if (this.processError) {
            try {
    ...
    async getProductsByCategory(arg0: string): Promise<Array<SeedProduct>> {
        if (this.processError) {
            try {
    ...
    async getSalesStats(): Promise<SalesStats> {
        if (this.processError) {
            try {
                const result = await this.actor.getSalesStats();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async searchProducts(arg0: string): Promise<Array<SeedProduct>> {
        if (this.processError) {
            try {
    ...
    async togglePaymentOption(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.togglePaymentOption(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
